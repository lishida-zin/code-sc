...
> **目標**: HTML/CSSコードの問題点を見抜き、レビューで指摘できる

## 🎯 到達基準
- [ ] セマンティックHTMLの違反を指摘できる
- [ ] アクセシビリティの問題を発見できる
- [ ] CSS設計の悪い部分を特定できる
- [ ] AIが書いたHTML/CSSの改善点を提案できる
...
| 問題 | 指摘例 |
|------|--------|
| !important乱用 | 「詳細度の設計を見直すべき」 |
| マジックナンバー | 「変数化すべき」 |
| floatレイアウト | 「Flexbox/Gridを使うべき」 |
| px固定 | 「レスポンシブ対応していない」 |
| 命名が曖昧 | 「.box → .card-containerなど意味のある名前に」 |
